AddEventHandler('chatMessage', function(source, name, msg)
	...
	elseif command == "/me" then
		CancelEvent()
		TriggerClientEvent('chatMessage', -1, _U('me_prefix', name), { 255, 0, 0 }, string.sub(msg,5))
	...
	elseif string.sub(command, 1, 1) == "/" then
		CancelEvent()
		TriggerClientEvent('chatMessage', source, 'System', {132, 13, 37}, _U('ooc_unknown_command'))
	end
end)
